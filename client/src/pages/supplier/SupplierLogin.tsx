...
export default function SupplierLogin() {
  ...
  const features = [
    { icon: Store, text: "Manage Your Store", color: "text-blue-600" },
    { icon: Package, text: "List Products", color: "text-green-600" },
    { icon: BarChart3, text: "Track Performance", color: "text-purple-600" },
    { icon: DollarSign, text: "Grow Revenue", color: "text-orange-600" }
  ];
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="hidden lg:flex flex-col justify-center space-y-8">
            <div>
              <div className="inline-flex items-center gap-2 bg-purple-100 rounded-full px-4 py-2 text-sm text-purple-700 font-medium mb-6">
              ...
              {features.map((feature, index) => {
                ...
                return (
                  <div key={index} className="bg-white rounded-xl p-4 shadow-lg border border-gray-100">
                    <div className={`w-10 h-10 rounded-lg bg-gradient-to-br ${feature.color === 'text-blue-600' ? 'from-blue-100 to-blue-200' : feature.color === 'text-green-600' ? 'from-green-100 to-green-200' : feature.color === 'text-purple-600' ? 'from-purple-100 to-purple-200' : 'from-orange-100 to-orange-200'} flex items-center justify-center mb-3`}>
